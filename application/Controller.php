...
abstract class Controller {
    ...
    protected function menu($menu = 'menu') {// Creo el menu dependiendo de los permisos
        ...
        $menus = new MenuModelo($menu, $this->_item, $this->_acl);
        $listasmenu = $menus->getMenu();
        if ($menu == 'menu') {
    ...
    protected function render($vista = FALSE, $plantilla = FALSE , $ajax = FALSE) {
        $this->_view->renderizar($vista, $plantilla,$ajax);
    }
