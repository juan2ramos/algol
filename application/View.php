...
class View {
    ...
    public function renderizar($vista = FALSE, $layout = FALSE, $noAjax = TRUE) {
        
        $vista = (!$vista?'index':$vista);
        ...
        //include_once ; 
        if (is_readable($rutaLayout . DS . 'header.php') and $noAjax) {
        ...
        if (is_readable($rutaLayout . DS . 'footer.php') and $noAjax) {
